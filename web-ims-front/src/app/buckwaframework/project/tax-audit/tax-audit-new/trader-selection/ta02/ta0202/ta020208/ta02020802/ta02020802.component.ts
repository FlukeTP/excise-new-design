...
const URL = {
  SEARCH: "ta/service-paper/inquiry-price-per-unit",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/service-paper/export-price-per-unit",
  UPLOAD: "ta/service-paper/upload-price-per-unit",
  SAVE: "ta/service-paper/save-price-per-unit",
  PAPER_PR_NUMBER: "ta/service-paper/paper-sv-number-list/price-per-unit",
}
@Component({
  selector: 'app-ta02020802',
  templateUrl: './ta02020802.component.html',
  styleUrls: ['./ta02020802.component.css']
})
export class Ta02020802Component implements OnInit {
      ...
      columns: [
        {
          ...
          data: "goodsPrice", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
