...
const URL = {
  SEARCH: "ta/product-paper/inquiry-output-foreign-goods",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-output-foreign-goods",
  UPLOAD: "ta/product-paper/upload-output-foreign-goods",
  SAVE: "ta/product-paper/save-output-foreign-goods",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/output-foreign-goods",
}

@Component({
  selector: 'app-ta02020710',
  templateUrl: './ta02020710.component.html',
  styleUrls: ['./ta02020710.component.css']
})
export class Ta02020710Component implements OnInit {
      ...
      columns: [
        {
          ...
          data: "cargoDocNo", className: "text-left"
        }, {
