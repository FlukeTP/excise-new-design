...
const URL = {
  SEARCH: "ta/service-paper/inquiry-tax-amt-additional",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/service-paper/export-tax-amt-additional",
  UPLOAD: "ta/service-paper/upload-tax-amt-additional",
  SAVE: "ta/service-paper/save-tax-amt-additional",
  PAPER_PR_NUMBER: "ta/service-paper/paper-sv-number-list/tax-amt-additional",
}
@Component({
  selector: 'app-ta02020805',
  templateUrl: './ta02020805.component.html',
  styleUrls: ['./ta02020805.component.css']
})
export class Ta02020805Component implements OnInit {
      ...
      columns: [
        {
          ...
          data: "goodsValue", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
          ...
          data: "taxAdditionalAmt", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
