...
declare var $: any;
const URL = {
  SEARCH: AjaxService.CONTEXT_PATH + "ta/basic-analysis/inquiry-tax-retail-price-data",
}
...
export class Ta02020202Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.setDataService();
    this.dataStore = this.store.select(state => state.Ta020202.Ta020202.anaResultText2).subscribe(data => {
      this.note = data
    });
  }
