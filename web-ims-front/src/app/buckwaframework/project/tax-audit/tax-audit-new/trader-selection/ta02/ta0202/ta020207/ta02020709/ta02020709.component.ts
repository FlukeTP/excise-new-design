...
const URL = {
  SEARCH: "ta/product-paper/inquiry-inform-price",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-inform-price",
  UPLOAD: "ta/product-paper/upload-inform-price",
  SAVE: "ta/product-paper/save-inform-price",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/inform-price",
}
