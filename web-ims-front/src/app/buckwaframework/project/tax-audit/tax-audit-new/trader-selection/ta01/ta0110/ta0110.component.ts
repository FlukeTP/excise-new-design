...
import { CondGroup, WorksheetHdr, FormSave, FormVo } from './ta0110.model';
import { ObjMonth, TableShowDetail, RequestStartLength } from '../../table-custom/table-custom.model';
...
@Component({
  selector: 'app-ta0110',
  templateUrl: './ta0110.component.html',
  styleUrls: ['./ta0110.component.css']
})
export class Ta0110Component implements OnInit {
