...
const URL = {
  SEARCH: "ta/product-paper/inquiry-unit-price-reduce-tax",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-unit-price-reduce-tax",
  UPLOAD: "ta/product-paper/upload-unit-price-reduce-tax",
  SAVE: "ta/product-paper/save-unit-price-reduce-tax",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/unit-price-reduce-tax",
}

@Component({
  selector: 'app-ta02020708',
  templateUrl: './ta02020708.component.html',
  styleUrls: ['./ta02020708.component.css']
})
export class Ta02020708Component implements OnInit {
  ...
  uploadFile(formBody: any) {
    ...
    this.ajax.upload(URL.UPLOAD, formBody, res => {
      if (MessageService.MSG.SUCCESS == res.json().status) {
        ...
        console.log("error uploadFile :", res.message);
        // disabled button save
        this.showBtSave = true;
      }
      ...
      columns: [
        {
          ...
          data: "billNo", className: "text-left"
        }, {
