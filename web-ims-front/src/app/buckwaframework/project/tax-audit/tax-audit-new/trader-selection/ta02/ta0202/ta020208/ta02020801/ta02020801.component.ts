...
const URL = {
  SEARCH: "ta/service-paper/inquiry-qty",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/service-paper/export-qty",
  UPLOAD: "ta/service-paper/upload-qty",
  SAVE: "ta/service-paper/save-qty",
  PAPER_PR_NUMBER: "ta/service-paper/paper-sv-number-list/qty",
}
@Component({
      ...
      columns: [
        {
          ...
          data: "serviceDocNoQty", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
          data: "incomeDailyAccountQty", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
          data: "paymentDocNoQty", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
