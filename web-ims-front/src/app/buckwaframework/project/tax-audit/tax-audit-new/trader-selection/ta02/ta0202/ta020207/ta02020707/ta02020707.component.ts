...
const URL = {
  SEARCH: "ta/product-paper/inquiry-reduce-tax",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-reduce-tax",
  UPLOAD: "ta/product-paper/upload-reduce-tax",
  SAVE: "ta/product-paper/save-reduce-tax",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/reduce-tax",
}
