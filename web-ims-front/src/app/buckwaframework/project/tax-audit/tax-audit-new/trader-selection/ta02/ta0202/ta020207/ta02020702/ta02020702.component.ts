...
const URL = {
  SEARCH: "ta/product-paper/inquiry-output-material",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-output-material",
  UPLOAD: "ta/product-paper/upload-output-material",
  SAVE: "ta/product-paper/save-output-material",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/output-material",
}
      ...
      columns: [
        {
          ...
          data: "outputMaterialQty", className: "text-right",
