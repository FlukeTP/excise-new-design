...
const URL = {
  SEARCH: "ta/product-paper/inquiry-tax-amt-additional",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-tax-amt-additional",
  UPLOAD: "ta/product-paper/upload-tax-amt-additional",
  SAVE: "ta/product-paper/save-tax-amt-additional",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/tax-amt-additional",
}

@Component({
  selector: 'app-ta02020711',
  templateUrl: './ta02020711.component.html',
  styleUrls: ['./ta02020711.component.css']
})
export class Ta02020711Component implements OnInit {
