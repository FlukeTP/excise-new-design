...
const URL = {
  SEARCH: "ta/product-paper/inquiry-relation-produced-goods",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-relation-produced-goods",
  UPLOAD: "ta/product-paper/upload-relation-produced-goods",
  SAVE: "ta/product-paper/save-relation-produced-goods",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/relation-produced-goods"
}
      ...
      columns: [
        {
          ...
          data: "usedMaterialQty", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
