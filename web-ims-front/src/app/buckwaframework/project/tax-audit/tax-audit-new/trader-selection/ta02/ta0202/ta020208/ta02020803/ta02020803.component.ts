...
const URL = {
  SEARCH: "ta/service-paper/inquiry-member",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/service-paper/export-member",
  UPLOAD: "ta/service-paper/upload-member",
  SAVE: "ta/service-paper/save-member",
  PAPER_PR_NUMBER: "ta/service-paper/paper-sv-number-list/member",
}
@Component({
