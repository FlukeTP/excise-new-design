...
const URL = {
  SEARCH: "ta/product-paper/inquiry-input-material",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-input-material",
  UPLOAD: "ta/product-paper/upload-input-material",
  SAVE: "ta/product-paper/save-input-material",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/input-material",
}

@Component({
  selector: 'app-ta02020701',
  templateUrl: './ta02020701.component.html',
  styleUrls: ['./ta02020701.component.css']
})
export class Ta02020701Component implements OnInit {
      ...
      columns: [
        {
          ...
          data: "dailyAccountQty", className: "text-right",
          render: (data, type, row, meta) => {
            return Utils.moneyFormatDecimal(data);
          }
        }, {
