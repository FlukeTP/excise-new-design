...
const URL = {
  SEARCH: "ta/product-paper/inquiry-output-goods",
  EXPORT: AjaxService.CONTEXT_PATH + "ta/product-paper/export-output-goods",
  UPLOAD: "ta/product-paper/upload-output-goods",
  SAVE: "ta/product-paper/save-output-goods",
  PAPER_PR_NUMBER: "ta/product-paper/paper-pr-number-list/output-goods",
}
